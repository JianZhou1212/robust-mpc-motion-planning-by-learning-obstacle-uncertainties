...
class Planner_Original( ):
    ...
    def ReachableSet(self, current_x_SV):
        ...
        Occupancy_SV = list( ) # aug approximation of SV occupancy
    ...
    def Return(self, current_x_SV, current_x_EV):
        ...
        RefYPos = RefPos[1]
        RefPhi  = RefPos[2]
        Trajectory_k, Control_k, J_k, s_k = self.MPCFormulation(G, g, current_x_EV, RefSpeed, RefXPos, RefYPos, RefPhi)
